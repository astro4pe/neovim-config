...
-- Keybinds to move lines using Alt-j/k
vim.keymap.set("v", "<A-j>", ":m '>+1<CR>gv-gv", { desc = "Move current line / block with Alt-j/k ala vscode." })
vim.keymap.set("v", "<A-k>", ":m '<-2<CR>gv-gv", { desc = "Move current line / block with Alt-j/k ala vscode." })
